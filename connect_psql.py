...
#         insert_query = """
#             INSERT INTO employees (firstname, lastname, religion, nationality, dob, tel, email, department_id, position_id, salary)
...
#     try:
#         employee = employee_data()  # Use get_employee_data() for non-GUI testing
